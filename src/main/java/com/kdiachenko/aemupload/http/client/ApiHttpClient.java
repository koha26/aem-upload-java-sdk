...
public interface ApiHttpClient {
     ...
     * @return API HTTP response wrapper
     */
    <E, R> ApiHttpResponse<R> post(String url, ApiHttpEntity<E> entity, ApiHttpContext apiHttpContext,
     ...
     * @return API HTTP response wrapper
     */
    <E, R> ApiHttpResponse<R> put(String url, ApiHttpEntity<E> entity, ApiHttpContext apiHttpContext,
                                  Class<R> responseType);
